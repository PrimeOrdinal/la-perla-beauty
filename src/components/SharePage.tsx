...
export type SharePageProps = ColorProps &
  FlexboxProps &
  GridProps &
  LayoutProps &
  PositionProps &
...
export const SharePageStyled: React.FC<SharePageProps> = styled.div`
...
export const SharePage: React.FC<SharePageProps> = props => {
  ...
  if (typeof navigator !== "undefined") {
    ...
    return <SharePageStyled {...props}>{output}</SharePageStyled>
  }

  return <SharePageStyled {...props}>share</SharePageStyled>
}
